...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container mt-5">
        ...
        <div class="card shadow-sm p-4 mt-4" style="max-width: 800px; margin: 0 auto;">
            ...
            <!-- This textbox now represents the number of points -->
            <asp:TextBox ID="RewardNameTextBox" runat="server" CssClass="form-control mb-2" Placeholder="Number Of Points"></asp:TextBox>
            <asp:FileUpload ID="RewardImageUpload" runat="server" CssClass="form-control mb-2" />
            <!-- Changed ID and placeholder from StreakHoursTextBox to StreakDaysTextBox -->
            <asp:TextBox ID="StreakDaysTextBox" runat="server" CssClass="form-control mb-2" Placeholder="Number of Streak Days"></asp:TextBox>
            ...
            <asp:Repeater ID="RewardsRepeater" runat="server" OnItemCommand="RewardsRepeater_ItemCommand">
                <ItemTemplate>
                    <div class="reward-item mb-3">
                        <img src='<%# ResolveUrl(Eval("RewardImage").ToString()) %>' alt="Reward Image" class="img-thumbnail mb-2" style="max-width: 150px;" />
                        <h5><%# Eval("RewardName") %></h5>
                        <!-- Updated label from 'Streak Hours' to 'Streak Days' and the field name from StreakHours to StreakDays -->
                        <p>Streak Days: <%# Eval("StreakDays") %></p>
        ...
        <div id="EditRewardSection" runat="server" class="card shadow-sm p-4 mt-4" style="max-width: 800px; margin: 0 auto; display: none;">
            ...
            <!-- This textbox represents points -->
            <asp:TextBox ID="EditRewardNameTextBox" runat="server" CssClass="form-control mb-2" Placeholder="Number Of Points"></asp:TextBox>
            <asp:FileUpload ID="EditRewardImageUpload" runat="server" CssClass="form-control mb-2" />
            <!-- Changed ID and placeholder for streak days -->
            <asp:TextBox ID="EditStreakDaysTextBox" runat="server" CssClass="form-control mb-2" Placeholder="Number of Streak Days"></asp:TextBox>
