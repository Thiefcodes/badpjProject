        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <asp:TextBox ID="txtSearch" runat="server" CssClass="form-control" 
                             placeholder="Search by product name"></asp:TextBox>
            </div>
            <div class="col-md-3">
                <asp:DropDownList ID="ddlCategory" runat="server" CssClass="form-control">
                    <asp:ListItem Text="All Categories" Value="" />
                    <%-- Additional items will be loaded dynamically in code-behind --%>
                </asp:DropDownList>
            </div>
            <div class="col-md-3">
                ...
                <tr>
                    <td>
                        <asp:HyperLink NavigateUrl='<%# "ProductDetails.aspx?productID=" + Eval("ProductID") %>'>
                            <asp:Image ID="imgProduct" runat="server" ImageUrl='<%# Eval("ImageUrl") %>'
                                CssClass="img-thumbnail" Height="50px" Width="50px" />
                        </asp:HyperLink>
                    </td>
                    <td>
                        <%# Eval("ProductName") %>
                    ...
                    <td>
                        <asp:HyperLink ID="hlViewMore" runat="server"
                            ...
                            CssClass="btn btn-info btn-sm" Text="View More" />
                        &nbsp;
